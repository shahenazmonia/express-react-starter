...
import { profileValidationSchema } from "../../_defaultComponents/CounselorAccountPage/profileValdationSchema";
...
const dispatchToProps = dispatch => {
  return {
    changePassword: params => dispatch(clinicActions.changePassword(params)),
